...
import com.spectigo.fotorganize.csv.PrestashopCSV;
...
public class ImportPS extends JFrame {
    ...
    public ImportPS() {
        this.setTitle("Import Prestashop");
    ...
    private void initComponents() {
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ImportPS.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
            	ImportPS.this.jButton2ActionPerformed(evt);
            }
        });
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        if (jfc.showOpenDialog(this) == 0) {
            ...
            try {
                this.data.initialize(dir, new PrestashopCSV(), true);
    ...
    public void doWork() {
        Runnable r = new Runnable(){
            ...
            public void run() {
                int i = 0;
                while (i < ImportPS.this.data.getNumberOfPhotos()) {
                	ImportPS.this.data.handlePhoto(i);
                	ImportPS.this.jProgressBar1.setValue(i + 1);
                    ++i;
                }
            }
        };
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(ImportPS.class.getName()).log(Level.SEVERE, null, ex);
        }
